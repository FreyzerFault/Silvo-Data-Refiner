...
class Grouper:
  ...
  def save_to_files(self, root_path: str) -> dict[str, dict[str, list[str]]]:
    ...
    for group_data in self.group_data_list.values():
      ...
      file_results[group_data.column] = {'dir_path': dir_path, 'files': group_data.file_names}
...
def group_by_to_files(df: pd.DataFrame, column_list: list[str], root_path: str) -> dict[str, dict[str, list[str]]]:
  """
